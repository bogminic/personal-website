...
exports.loadStaticFiles = () => ({
  plugins: [
    new CopyPlugin([
        ...
        { from: 'images/neuron-contact-right.png', to: 'images' },
        { from: 'images/neuron-contact-left.jpg', to: 'images' },
        { from: 'images/neuron-resume-right.png', to: 'images' },
        { from: 'images/neuron-resume-left.png', to: 'images' },
        { from: 'images/neuron-about-right.png', to: 'images' },
        { from: 'images/neuron-about-right-top.jpg', to: 'images' },
